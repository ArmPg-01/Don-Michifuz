...
let pp = gataImg
const cat = `ᴅᴏɴ ᴍɪᴄʜɪꜰᴜᴢ 
* ${bot}

*---------------------*

*CENTER DON MICHIFUZ*
*armandopg990827@gmail.com*

DON MICHIFUZ - ASISTENCIA
*${asistencia}*
...
description = official[0][0] == String(contact[0]) ? 'Solo temas de Don Michifuz' : official[1][0] == String(contact[0]) ? lenguajeGB.smsContacto4() : official[2][0] == String(contact[0]) ? lenguajeGB.smsContacto4() : official[3][0] == String(contact[0]) ? lenguajeGB.smsContacto4() : desc === '' ? lenguajeGB.smsContacto5() : desc
correo = official[0][0] == String(contact[0]) ? 'wa.me/5215533545291' : official[1][0] == String(contact[0]) ? '' : official[2][0] == String(contact[0]) ? 'wa.me/5215533545291' : mail === '' ? lenguajeGB.smsContacto6() : mail
...
enlace = official[0][0] == String(contact[0]) ? 'wa.me/5215533545291' : official[1][0] == String(contact[0]) ? 'wa.me/5215533545291' : official[2][0] == String(contact[0]) ? 'wa.me/5215533545291' : official[3][0] == String(contact[0]) ? 'wa.me/5215533545291' : md 

lista.push([number, ofc, nombre, description, official[3][0] == String(contact[0]) ? null : correo, lugar, enlace, bio, official[1][0] == String(contact[0]) ? 'wa.me/5215533545291' : null]) }  
lista.push([conn.user.jid.split('@')[0], await conn.getName(conn.user.jid), packname, lenguajeGB.smsContacto8(), mail === '' ? 'wa.me/5215533545291' : mail, lenguajeGB.smsContacto7(), md, bioBot, yt, ig, fb, paypal, nna])
await conn.sendFile(m.chat, pp, 'lp.jpg', cat, fkontak, false, { contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' 😻 ᴅᴏɴ ᴍɪᴄʜɪꜰᴜᴢ - ᴡʜᴀᴛꜱᴀᴘᴘ ', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb.getRandom()}}})
