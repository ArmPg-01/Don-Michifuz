...
this.sendMessage(m.chat, {text: `🐈 𝙉𝙊 𝙏𝙄𝙀𝙉𝙀 𝘾𝙊𝙄𝙉𝙎`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' 😻 ᴅᴏɴ ᴍɪᴄʜɪꜰᴜᴢ - ᴡʜᴀᴛꜱᴀᴘᴘ ', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}}, { quoted: m })         
continue     
}
			
m.exp += xp
if (!isPrems && plugin.limit && global.db.data.users[m.sender].limit < plugin.limit * 1) {
this.sendMessage(m.chat, {text: `${lenguajeGB['smsCont7']()} *${usedPrefix}buy*`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' 😻 ᴅᴏɴ ᴍɪᴄʜɪꜰᴜᴢ - ᴡʜᴀᴛꜱᴀᴘᴘ ', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}}, { quoted: m })         
//this.reply(m.chat, `${lenguajeGB['smsCont7']()} *${usedPrefix}buy*`, m)
continue //Sin límite
}
if (plugin.level > _user.level) {
this.sendMessage(m.chat, {text: `${lenguajeGB['smsCont9']()} *${plugin.level}* ${lenguajeGB['smsCont10']()} *${_user.level}* ${lenguajeGB['smsCont11']()} *${usedPrefix}nivel*`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' 😻 ᴅᴏɴ ᴍɪᴄʜɪꜰᴜᴢ - ᴡʜᴀᴛꜱᴀᴘᴘ ', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}}, { quoted: m })         
...
text = (action === 'add' ? (chat.sWelcome || this.welcome || conn.welcome || 'Welcome, @user!').replace('@subject', await this.getName(id)).replace('@desc', groupMetadata.desc?.toString() || '😻 ᴅᴏɴ ᴍɪᴄʜɪꜰᴜᴢ 😻') :
...
"thumbnail": apii.data, 
"title": [wm, '😻 ᴅᴏɴ ᴍɪᴄʜɪꜰᴜᴢ - ᴡʜᴀᴛꜱᴀᴘᴘ ' + gt + ' 😻', '🌟'].getRandom(),
"containsAutoReply": true,
"mediaType": 1, 
sourceUrl: 'https://github.com/ArmPg-01/Don-Michifuz' }}}, { quoted: fkontak2 })
apii.data = ''
